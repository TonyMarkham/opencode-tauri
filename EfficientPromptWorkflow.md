...
### Document
```txt
Can you please serialize that to `session_9_prod_plan.md`?
```
...
### Implement
```txt
I'd like you to read `CRITICAL_OPERATING_CONSTRAINTS.md`  And using those guidelines help me implement `session_9_prod_plan.md`
